...
def orchestrator_function(context: df.DurableOrchestrationContext):
    ...
    # user dag execution
    cbza = yield context.call_activity("InvokeAndCircuitSplit", serwoObject)
    cxlu = yield context.call_activity("SubmitCircuits", cbza)
    xeof = yield context.call_activity("WaitFn", cxlu)
    elhw = yield context.call_activity("Poll", xeof)
    elhw = insert_end_stats_in_metadata(elhw)
    hnwr = yield context.call_activity("CollectLogs", elhw)
    return hnwr
